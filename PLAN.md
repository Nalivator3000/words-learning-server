...
- [ ] **Глобальные наборы слов (Word Collections)** 🎯 ВЫСОКИЙ ПРИОРИТЕТ
  - Системные наборы слов от администратора
  ...
  - Статистика использования наборов
  - Админ-панель для управления наборами
