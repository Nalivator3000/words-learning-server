...
const languages = [
  { code: 'ru', file: 'themes-russian-batch3.json', table: 'source_words_russian' },
  { code: 'ar', file: 'themes-arabic-batch3.json', table: 'source_words_arabic' },
  { code: 'it', file: 'themes-italian-batch3.json', table: 'source_words_italian' },
  { code: 'pt', file: 'themes-portuguese-batch3.json', table: 'source_words_portuguese' },
  { code: 'tr', file: 'themes-turkish-batch3.json', table: 'source_words_turkish' },
  { code: 'uk', file: 'themes-ukrainian-batch3.json', table: 'source_words_ukrainian' }
];
...
async function main() {
  console.log('🚀 Batch 3 Theme Application\n');
