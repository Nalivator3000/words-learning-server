...
async function extractWords() {
  try {
    console.log('\n📚 Извлечение слов Japanese для переназначения тем...\n');
    ...
    fs.writeFileSync('japanese-words-for-themes.txt', words.join('\n'), 'utf-8');

    console.log(`✓ Записано в japanese-words-for-themes.txt`);
    console.log(`\nПримеры слов:`);
